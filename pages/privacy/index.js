...
const Privacy = () => {
    return (
        ...
        >
            ...
            This Privacy Policy explains who we are, how we process (i.e. collect, record, organize, structure, store, adapt or alter, retrieve, consult, use, disclose by transmission, disseminate or otherwise make available, align or combinate, restrict, erase or destruct) personal information about you, and how you can exercise your privacy rights. We are WeWe Technology JSC, a company under laws of Vietnam, with registered address at: 44 Le Van Duyet Street, Binh Thanh District, HCMCT, the owner of Voiz FM - the high-quality audio platform, 100% copyright that are made available via app stores including the Apple App Store and Google Play Store. This Privacy Policy applies to personal information that we collect through our website, mobile applications. By using our Services, you agree to be bound by this Privacy Policy and consent to our processing of information as specified therein.

            1. INFORMATION WE COLLECT FROM YOU
            Most of the information that we collect about you comes directly from you when you use our website or mobile app. In general, the information we collect about you relates to the type of device you are using, information that helps us identify your device, how you use our mobile app and may include information that you submit to us when you voluntarily contact us. We may also collect information from app store platforms and partners and other third parties such as information about your interests and in-app purchases (provided that we never receive your payment or credit card information).
            ...
            - your name, email address, phone number, image or other details, necessary to process your inquiries;
            ...
            - Data and analytics about your use of our Services (e.g. in-app search log, in-app interaction, installed apps, etc)
            ...
            - Third-Party Social Network/s. Google Play Games Service, Apple Game Center, Facebook (“Third-Party Social Network/s”). You may choose to connect to our Services via your social media account. Exactly what information we receive from your social media will depend on your social media privacy settings, but it would typically include your basic public profile information such as your username, gender, your friends. (See below also “Third-Party Social Networks”).

            - Third party service providers. We may receive personal information about you from third-party sources. We may get your personal information for example when you installed our app and prior to installing you have clicked an advertisement for the same service.

            - Advertising partners. From time to time, we may also receive personal information about you from other third-party sources. For example, if you clicked on an advertisement to direct you to one of our Services (such as an advert of one of our audiobooks in another publisher’s game), we will be provided with information from which ad network and advertising campaign the install originated from (See below also “Advertising”).
            ...
            We use the information we collect about you/your device to deliver services and our audiobooks to you and to operate our business. We use it also for improving our services and audiobooks, for enhancing security and for analytics and research purposes to make sure we provide you with the best experience. In addition, we use your information to promote our services and audiobooks in our app and also in other publisher’s apps and to display third-party advertisements to you. We use your information also for tracking and fraud prevention for advertising purposes and for complying with our legal obligations.

            We use your information for the following purposes:

            1. Delivering and improving our services. We use your information for developing, delivering and improving our app and other products, services, and content, tailoring our products and services, providing audiobook updates, technical troubleshooting, understanding and analyzing trends in connection with usage of the audiobooks, and administering the audiobooks.

            2. Displaying advertisements. We use your information for showing advertisements for our audiobooks in other publisher’s apps and for displaying third-party advertisements in our app. Please see more in the Advertising Section of this Privacy Policy.

            3. Cross-promotion. We use your information for cross-promoting our audiobooks and services, meaning to promote one of our audiobooks while you are listening to a different audiobook of ours.
            ...
            5. Analytics and research. We use your information for understanding and analyzing trends in connection with the usage of the app, gathering demographic information about our user base, and data about where the app was downloaded from. We may also create reports and analysis for the purposes of research or business intelligence, for example to track potential problems or trends with our app and services, or to test our new audiobook features and content.

            6. Security. We use your information for enhancing the safety and security of our app, products and services.
            ...
            Our audiobooks enable in-app purchases. We do not process payments for in-app purchases nor have access to your credit card information.

            Payment transactions for in-app purchases are completed through the app store via your App Store account, Google Play account. Any post-purchase processes are controlled by the Apple, Google stores and are subject to specific terms of such Apple, Google stores. Please review the privacy policy and terms of service of your Apple, Google stores.

            3. HOW WE SHARE YOUR INFORMATION
            We cannot provide all services necessary for the successful operation of the app by ourselves. We must, therefore, share collected information with third parties for the purposes of developing and delivering our services, displaying advertisements, conducting analysis and research and for measuring our and our Partners’ advertising campaign performance. We also reserve the right to disclose your information (including personally identifiable information) when we are legally required to do so, to disclose your information in an anonymous and aggregated manner, meaning you could not be personally identified from it.

            We may share such information to:

            - Our analytics providers. We use third-party analytics for the purposes of delivering our services, conducting analysis, and research. The device data we share with such providers are encoded. The providers may assign a random ID to these data and they are not able to match it back to You. We can aggregate the data for benchmarking features.
            ...
            - Our tracking and fraud prevention providers. For some of our audiobooks we use tracking and fraud prevention providers for the purposes of measuring performance and optimizing our advertising campaigns, displaying advertisements, conducting analysis to improve our services and for fraud prevention purposes. Such providers may use APIs, and SDKs in our app to enable them to collect and analyze user and device-related data and information, such as impressions, clicks, installs or other advertising campaign performance indicators and post-install in-app events.

            - Third-party advertising partners. We have contracted with certain third-party advertising networks that assist us in delivering advertising to you that allows us to continue offering the audiobooks for free or at low cost.
            ...
            We may contract with additional Partners or change existing Partners in the future to perform any services in connection with the app. These changes shall be updated from time to time or promptly in case of material changes in our data processing practices.
            ...
            Our app uses third-party services such as Google Play Games Service, Apple Game Center, Facebook (“Third Party Social Network/s”). The app enables you to log in to your Third-Party Social Network account to connect our App by using the “Log in” feature in our App. You may also share the content you create within the App on Third-Party Social Networks. Please note, Third Party Social Networks are governed by their own privacy policies, terms and end-user agreements and we are not responsible for and have no control over the sharing practices or policies of the third parties that operate those sites.

            5.2. Information We May Receive When You Connect to Third-Party Social Networks

            The information you allow us to access varies by App and is affected by the privacy settings you establish on those Third-Party Social Networks. You can control and find out more about these settings from the Third-Party Social Network in question. When you use the “Log in” feature, we may access and store some or all of the following information, as allowed by you, Third-Party Social Networks and your preferences: (i) your basic information from your public profile, such as your nickname, profile picture; (ii) login ID and/or player identifier string; (iii) list of your friends; (iv) any other information which is detailed and displayed to you in the notice which appears during the “Log in with” process.
            ...
            You have certain rights in connection with your personal information and how we handle it. Some of these rights may be subject to some exceptions or limitations. You can exercise these rights at any time by following the instructions below or sending us relevant requests to marketing@wewe.vn.

            Your rights include:

            - Right to correct your data (e.g. you can contact us if your email address has been changed and we should replace your old email address)

            - Right to have your data deleted (e.g. you can contact us if you want us to delete certain data that we have stored about you)

            - Right to restrict processing of your personal information (e.g. you can contact us if you want to restrict processing)

            - Right to take your data with you (e.g. you can contact us to receive your data if you want to upload it to another service)

            - Right to object how your data is handled (e.g. you can contact us if you do not agree with any user analytics procedures as described within this privacy policy)

            - Right to send complaints to the supervisory authority (e.g. you can contact the data protection supervisory authority directly).

            7. GENERAL

            Your information privacy and security is important to us and we always pay special attention to ensure that we process your information lawfully. We store your information for as long as needed to provide you with our services. We may store information longer, but only in a way that it cannot be tracked back to you. Please check regularly for changes to our Privacy Policy.
            ...
            We will occasionally update this Privacy Policy as necessary to protect our users, furnish current information, and respond to legal and technical changes. For previous versions of this Privacy Policy, please contact us via marketing@wewe.vn.

            11. CONTACT US

            If you have questions or concerns about this Privacy Policy, please contact us through one of the following ways:

            1. for privacy questions and exercising your rights via our privacy email: marketing@wewe.vn;

            2. If you have a concern or compliance regarding our treatment of your personal data you can contact the relevant data protection authority. For more information on which authority to contact, please email us here marketing@wewe.vn.

            For information collected under this Privacy Policy, the data controller is WeWe Technology JSC, a company under laws of Vietnam, with registered address at: 44 Le Van Duyet Street, Binh Thanh District, HCMCT, the owner of Voiz FM - the high-quality audio platform, 100% copyright
