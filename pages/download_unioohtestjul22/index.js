...
function DownloadTestPage() {
  ...
  const { isIOS, isAndroid } = useMobileAgentCheck();
  let redirectUrl = '/';
  if (isIOS) redirectUrl = 'https://apps.apple.com/us/app/voiz-fm-s%C3%A1ch-n%C3%B3i-podcast/id1447395824?ppid=39f15d5d-1a2c-464f-b745-08b400375c25';
