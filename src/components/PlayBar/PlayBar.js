...
export default function PlayBar() {
  ...
  return (
    ...
    >
      ...
      <audio id="audio" hidden preload="auto" ref={audio} />
      {isSm && (
        <Button
          sx={{
            bgcolor: COLORS.bg2,
      ...
      >
        <Avatar
          ...
          alt="audio avt"
          src={
            audioData?.avatar?.original_url ||
            audioData?.playlist?.avatar?.original_url
          }
        />
        <Box
          sx={{
      ...
      {!isSm && (
        ...
        >
          ...
          <Divider
            sx={{ color: COLORS.blackStroker, margin: "0 24px" }}
