...
export default function ChannelDetail({ channelFromAPI }) {
  ...
  useEffect(() => {
    if (channel) {
      const newUrl = getSharedLink(get(channel , 'slug', ''), SharedType.Channel);
      setUrl(newUrl);
    }
  }, [channel]);
  ...
  const updatedBookmarkStatus = (data) => {
    ...
    updatedChannel["channel_counter"]["bookmarks_count"] =
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    {channel?.channel_counter?.bookmarks_count}
                  </Typography>
                  <Typography
                    sx={{
                      ...(isSm ? TEXT_STYLE.title1 : TEXT_STYLE.h3),
            ...
            >
              ...
              >
                {channel?.is_bookmark ? "Hủy theo dõi" : "Theo dõi"}
              </Button>
            </Box>
          </Box>
        </Box>
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Danh sách album ({channel?.channel_counter?.playlists_count}{" "}
              albums)
            </Typography>
            <Box
              sx={{
